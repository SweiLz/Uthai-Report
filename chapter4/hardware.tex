...
เมื่อเปรียบเทียบผลลัพธ์น้ำหนักส่วนขาของหุ่นยนต์กนกกับหุ่นยนต์ฮิวมานอยด์ UTHAIแล้วได้ผลดังตาราง \ref{tab:UTHAI_KANOK_Comp}
